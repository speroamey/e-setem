...
const routes: Routes = [
    {
        ...
        children: [
            { path: 'ressources-humaines', loadChildren: './ressources-humaines/rh.module#RhModule' },
            { path: 'parametres', loadChildren: './parametres/parametres.module#ParametresModule' },
